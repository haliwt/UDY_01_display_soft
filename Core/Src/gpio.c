...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, TM1639_STB_Pin|TM1639_DIO_Pin|LED_POWER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TM1639_SCLK_GPIO_Port, TM1639_SCLK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED_CTL_Pin|LED_DRY_Pin|LED_MOUSE_Pin|LED_PLASMA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : TM1639_STB_Pin TM1639_DIO_Pin LED_POWER_Pin */
  GPIO_InitStruct.Pin = TM1639_STB_Pin|TM1639_DIO_Pin|LED_POWER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : TM1639_SCLK_Pin */
